      ...
      <div ref={pdfContentRef} className="pdf-print-area" style={{ display: "none" }}>
        ...
        <div className="pdf-stats-row">
          <div className="pdf-stat-box">
            ...
            <div className="pdf-stat-val">₹{totalRevenue.toLocaleString()}</div>
          </div>
          <div className="pdf-stat-box">
          ...
          <div className="pdf-stat-box">
            ...
            <div className="pdf-stat-val">₹{avgBill}</div>
          </div>
          <div className="pdf-stat-box">
            <div className="pdf-stat-label">Highest Bill</div>
            <div className="pdf-stat-val">₹{highestBill}</div>
          </div>
        </div>
        ...
        <div className="pdf-footer">
          This report was generated by Cafe &amp; Snacks Admin System
        </div>
      </div>
          ...
          <div className="sales-stat-row">
            ...
            <div className="sales-stat-card">
              ...
              <div className="stat-body">
                ...
                <div className="stat-value">₹{avgBill}</div>
            ...
            <div className="sales-stat-card">
              ...
              <div className="stat-body">
                ...
                <div className="stat-value">₹{highestBill}</div>
                <div className="stat-sub">{filterLabel}</div>
              </div>
            </div>
          </div>
          ...
          <div className="sales-table-card">
                ...
                filtered.map((o, i) => {
                  ...
                  return (
                    <div className="sales-table-row" key={o._id}>
                      ...
                      <span className="sales-row-amount">₹{o.total.toLocaleString()}</span>
            ...
            {filtered.length > 0 && (
              <div className="sales-table-footer">
                ...
                <span className="sales-footer-amount">₹{totalRevenue.toLocaleString()}</span>
              </div>
            )}
          </div>
