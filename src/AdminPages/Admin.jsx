...
// { type: "item"|"category", action: "added"|"edited", name: string }
  ...
  const item = menu.find(i => i._id === deleteId);
  const itemName = item ? localize(item.name) : "";
  ...
  const catName = localize(catToDelete.name);
  ...
  if (activeCategory?._id === catToDelete._id) {
