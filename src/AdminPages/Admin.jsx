  ...
  />
          ...
          <div className="category-bar" ref={catMenuRef}>
                ...
                {openCatMenu === cat._id && (
                  <div className="cat-dropdown">
                    <button className="cat-dropdown-item"
                      onClick={() => {
                        setEditCat(cat);
                        setEditCatName(typeof cat.name === "object" ? (cat.name[currentLang] || cat.name.en || "") : cat.name);
                        setOpenCatMenu(null);
                      }}>
                      {t("common.edit")}
                    </button>
            ...
            {showAddCat ? (
              <div className="add-cat-inline">
                <input
                  placeholder={currentLang === "en" ? "Category name" : currentLang === "ta" ? "வகை பெயர்" : "श्रेणी नाम"}
                  value={newCategory}
                  onChange={(e) => setNewCategory(e.target.value)}
                  onKeyDown={(e) => e.key === "Enter" && addCategory()} autoFocus />
                <button onClick={addCategory}>{t("common.add")}</button>
              ...
              <div className="form-field">
                ...
                <div className="lang-inputs">
                  <div className="lang-input-row">
                    <input
                      placeholder={
                        currentLang === "en" ? "e.g. Cappuccino" :
                        currentLang === "ta" ? "எ.கா. கப்புச்சினோ" :
                        "जैसे कैप्पुचिनो"
                      }
...
// with keys(work for translation)
...
//                   </div>
//                   <div className="lang-input-row">
//                     <span className={`lang-tag${formData.name.ta ? " lang-tag-filled" : ""}`}>TA</span>
//                     <input
//                       placeholder="விரும்பினால் — super admin translates"
//                       value={formData.name.ta}
//                       onChange={e => handleNameChange("ta", e.target.value)}
//                     />
//                   </div>
//                   <div className="lang-input-row">
//                     <span className={`lang-tag${formData.name.hi ? " lang-tag-filled" : ""}`}>HI</span>
//                     <input
//                       placeholder="वैकल्पिक — super admin translates"
//                       value={formData.name.hi}
//                       onChange={e => handleNameChange("hi", e.target.value)}
//                     />
//                   </div>
//                   <div className="lang-input-hint">English is required. Tamil &amp; Hindi are optional — super admin can auto-translate empty fields.</div>
//                 </div>
//               </div>
//               <div className="form-field">
//                 <label>{t("admin.form.price")} ({settings.currency})</label>
