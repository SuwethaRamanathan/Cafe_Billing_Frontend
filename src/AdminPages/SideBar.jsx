...
export default function SideBar() {
  ...
  const navItems = [
    { label: t("nav.menuManagement"), path: "/admin" },
    { label: t("nav.viewSales"),      path: "/sales" },
    { label: t("nav.viewStock"),      path: "/admin/stock/view" },
    { label: t("nav.updateStock"),    path: "/admin/stock/update" },
  ...
  return (
    <>
      ...
      {showLogout && (
        <div className="modal-overlay">
          <div className="modal-box">
            <div className="modal-title">{t("nav.confirmLogout")}</div>
            <p className="confirm-text">{t("nav.logoutConfirmText")}</p>
            <div className="form-row">
              <button className="btn-danger" onClick={handleLogout}>{t("nav.yesLogout")}</button>
              <button className="btn-cancel" onClick={() => setShowLogout(false)}>{t("common.cancel")}</button>
            </div>
          </div>
        </div>
      )}
